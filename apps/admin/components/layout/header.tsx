    ...
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur-md supports-[backdrop-filter]:bg-background/80 shadow-sm">
      <div className="flex h-14 items-center px-4">
        ...
        <div className="flex items-center gap-2.5 mr-6">
          ...
          <span className="text-base font-semibold hidden sm:inline-block bg-gradient-to-r from-foreground to-foreground/70 bg-clip-text text-transparent">
            众慧图书管理系统
          </span>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative group">
            ...
            {/* 用户下拉菜单 */}
            <div className="absolute right-0 top-full mt-1.5 hidden w-48 rounded-lg border bg-popover/95 backdrop-blur-sm p-1 shadow-xl group-hover:block animate-in fade-in-0 zoom-in-95">
              <Link
                href="/profile"
